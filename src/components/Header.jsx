         ...
         <nav className="flex justify-between items-center mx-auto max-w-7xl px-6 lg:px-8">
          ...
          <div>
           <ul className="flex  items-center gap-8 md:space-x-10 xl:space-x-24 text-sm text-slate-300 font-medium justify-between ">
            ...
            <li className=" bg-gradient-to-r from-[#06B6D4]  to-[#8B5CF6] text-white rounded-lg px-5 py-2 shadow-[0_0_25px_rgba(139,92,246,0.2)] hover:shadow-[0_0_35px_rgba(139,92,246,0.35)] transition-all duration-300 font-medium hover:scale-[1.02] active:scale-[0.98]"><a href="/login">LOGIN</a></li>
